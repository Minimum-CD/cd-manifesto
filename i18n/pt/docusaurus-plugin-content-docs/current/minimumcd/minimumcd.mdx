...
- A _pipeline_ decide a possibilidade dessas mudanças serem replicadas para o ambiente produtivo. Esse veredicto é [definitivo](/docs/faq/#why-should-the-pipeline-be-definitive-for-deploy)
- Os artefactos criados pela _pipeline_ respeitam sempre a [definição de _deployable_](/docs/faq/#what-do-we-mean-by-definition-of-deployable) da organização
- [Artefacto imutável](..//docs/minimumcd/immutable/) (não existem mudanças manuais após o _commit_)
...
- A [configuração da aplicação](/docs/faq/#what-is-application-configuration) é _deployed_ com o artefacto
...
Para obter informações acerca do Mínimo CD e respostas a outras questões comuns, por favor [lê as FAQ](/docs/faq) (versão inglesa).

## Começando a jornada

Dúvidas sobre como começar? Confira algumas [recomendações](/docs/journey) (versão inglesa).
...
Os signatários assinaram a [versão original em inglês](..//docs/minimumcd#signatories) e a lista atual de nomes é publicada apenas nessa versão.
