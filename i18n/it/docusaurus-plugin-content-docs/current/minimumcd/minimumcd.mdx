...
- [Trunk-based development](/docs/minimumcd/tbd/)
...
I firmatari hanno firmato la [versione originale in inglese](/docs/minimumcd#signatories) e la lista corrente dei nomi è pubblicata solo in quella versione
