...
- O _pipeline_ decide se as mudanças atendem ou não os requisitos para entrada em produção. Esse veredicto é [definitivo](/docs/faq/#why-should-the-pipeline-be-definitive-for-deploy)
- Os artefatos criados pelo _pipeline_ respeitam sempre a [definição de _deployable_](/docs/faq/#what-do-we-mean-by-definition-of-deployable) da organização
- [Artefato imutável](..//docs/minimumcd/immutable/) (não existem mudanças manuais após o _commit_)
...
- A [configuração da aplicação](/docs/faq/#what-is-application-configuration) é implantada junto com o artefato
...
Para obter informações acerca do Mínimo CD e respostas a outras questões comuns, por favor [leia o FAQ](/docs/faq) (versão inglesa).
