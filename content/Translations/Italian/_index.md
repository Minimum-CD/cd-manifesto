...
- La [application pipeline](https://beyond.minimumcd.org/docs/reference/practices/single-path-to-production/) è l'unico percorso per il rilascio in produzione
- La pipeline decide la rilasciabilità delle modifiche software, e il suo verdetto è [definitivo](https://beyond.minimumcd.org/docs/reference/practices/deterministic-pipeline/)
- Gli artefatti creati dalla pipeline soddisfano sempre la [definizione di rilasciabilità](https://beyond.minimumcd.org/docs/reference/practices/definition-of-deployable/) della specifica organizzazione
- [Artefatti immutabili](https://beyond.minimumcd.org/docs/reference/practices/immutable-artifacts/): nessuna modifica manuale dopo i commit
- Tutto il lavoro si ferma se la pipeline fallisce
- [Utilizzare ambienti di test il più possibile simili all'ambiente di produzione](https://beyond.minimumcd.org/docs/reference/practices/production-like-environments/)
- [Rollback su richiesta](https://beyond.minimumcd.org/docs/reference/practices/rollback/)
- La [configurazione dell'applicazione](https://beyond.minimumcd.org/docs/reference/practices/application-configuration/) viene distribuita assieme agli artefatti
...
- [Trunk-based development](https://beyond.minimumcd.org/docs/reference/practices/trunk-based-development/)
