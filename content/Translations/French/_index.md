...
- Le [pipeline de déploiement](https://beyond.minimumcd.org/docs/reference/practices/single-path-to-production/)
  est le seul chemin qui permet de déployer en production.
- Le pipeline décide de la diffusion des modifications, son verdict est [définitif](https://beyond.minimumcd.org/docs/reference/practices/deterministic-pipeline/)
...
- [L'artefact ne change jamais](https://beyond.minimumcd.org/docs/reference/practices/immutable-artifacts/). Il n'y a aucun changement humain après le commit.
...
- [La configuration de l'application](https://beyond.minimumcd.org/docs/reference/practices/application-configuration/) est déployée avec l'artefact
...
- [Le développement basé sur un tronc commun](https://beyond.minimumcd.org/docs/reference/practices/trunk-based-development/)
...
[Le développement basé sur un tronc commun](https://beyond.minimumcd.org/docs/reference/practices/trunk-based-development/) est le modèle de branche requis pour répondre à la définition d'Intégration Continue.
