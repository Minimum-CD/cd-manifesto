...
- එම [මෘදුකාංග යෙදුම් මාර්ගය pipeline](https://beyond.minimumcd.org/docs/reference/practices/single-path-to-production/)
  මෘදුකාංග බෙදාහැරීමේ එකම මාර්ගය වේ
- එම යෙදුම් මාර්ගය (pipeline) වෙනස්කම්වල මුදා හැරීම තීරණය කරයි, එහි තීන්දුව [නිශ්චිත තීන්දුවවේ](https://beyond.minimumcd.org/docs/reference/practices/deterministic-pipeline/)

- එම මාර්ගයෙන් නිර්මාණය කරන ලද වස්තුන් සෑම විටම ආයතනයේ [බෙදාහැරිය හැකි අර්ථ දැක්වීම සපුරාලයි](https://beyond.minimumcd.org/docs/reference/practices/definition-of-deployable/)
- [විචල්‍ය නොවන වස්තුන්](https://beyond.minimumcd.org/docs/reference/practices/immutable-artifacts/) (සැකසීමෙන් පසු කිසි පුද්ගලයෙකුට මේ වස්තුන් වෙනස් කල නොහැක)
- මෘදුකාංග යෙදුම් මාර්ගය (pipeline) රතු වූ විට සියලුම සියලු වැඩ නතර වේ
- [Production-වලට සමාන පරීක්ෂණ පරිසර](https://beyond.minimumcd.org/docs/reference/practices/production-like-environments/)
- [සැණකින් ප්‍රකූර්ති තත්වයට පත්කල හැකි පරීක්ෂණ පරිසර](https://beyond.minimumcd.org/docs/reference/practices/rollback/)
- [යෙදුම් වින්‍යාසය](https://beyond.minimumcd.org/docs/reference/practices/application-configuration/)වස්තුන් සමඟ එකට බෙදාහැරේ
...
[Trunk-based සංවර්ධනය](https://beyond.minimumcd.org/docs/reference/practices/trunk-based-development/) යනු නිර්වචනය වන්නේ මූලාශ්‍ර පාලනයට අවශ්‍ය එක අත්තක් විතරක් බාවිතාකරන රටාවයි, වෙනත් විදියකට CI ක්‍රියාවලිය කල නොහැක. මෙම විදිය code ඒකාබද්ධ වීමේදී සිදුවෙන දුෂිතවීම් වලක්වයි
